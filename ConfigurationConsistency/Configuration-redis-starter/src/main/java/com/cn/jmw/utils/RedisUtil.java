...
//    }
//
//    public void setRedisByLock(String key,String val) {
//        final RLock lock = redissonClient.getLock("lock");
//
//        lock.lock();
//        set(key,val);
...
//    }
//
//    public void setResumeContact(String key,String lockName) {
//        final RLock lock = redissonClient.getLock(lockName);
//        lock.lock();
//        setExpired(key, "exists", 300000L, TimeUnit.MILLISECONDS);
//        lock.unlock();
//    }
//
//    public final RLock getLock(String lockName){
//        final RLock lock = redissonClient.getLock(lockName);
//        return lock;
//    }
